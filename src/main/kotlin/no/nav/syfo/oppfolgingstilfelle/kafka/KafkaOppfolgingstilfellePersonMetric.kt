...
const val KAFKA_CONSUMER_OPPFOLGINGSTILFELLE_PERSON_AKTIVITETSKRAV_VURDERING_UPDATED =
    "${KAFKA_CONSUMER_OPPFOLGINGSTILFELLE_PERSON_BASE}_updated_aktivitetskrav_vurdering"
...
val COUNT_KAFKA_CONSUMER_OPPFOLGINGSTILFELLE_PERSON_AKTIVITETSKRAV_VURDERING_CREATED: Counter =
    Counter.builder(KAFKA_CONSUMER_OPPFOLGINGSTILFELLE_PERSON_AKTIVITETSKRAV_VURDERING_CREATED)
        ...
        .register(METRICS_REGISTRY)
val COUNT_KAFKA_CONSUMER_OPPFOLGINGSTILFELLE_PERSON_AKTIVITETSKRAV_VURDERING_UPDATED: Counter =
    Counter.builder(KAFKA_CONSUMER_OPPFOLGINGSTILFELLE_PERSON_AKTIVITETSKRAV_VURDERING_UPDATED)
        .description("Counts the number of aktivitetskrav-vurdering updated from topic - oppfolgingstilfelle-person")
        .register(METRICS_REGISTRY)
