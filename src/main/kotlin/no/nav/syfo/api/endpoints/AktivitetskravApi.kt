            ...
            checkVeilederTilgang(
                ...
                val responseDTOList = aktivitetskravAfterCutoff.map { aktivitetskrav ->
                    val vurderingResponseDTOs = aktivitetskrav.vurderinger.map { vurdering ->
                        ...
                        AktivitetskravVurderingResponseDTO.Companion.from(vurdering, varsel)
                    }
                    AktivitetskravResponseDTO.Companion.from(aktivitetskrav, vurderingResponseDTOs)
                }
        ...
        post {
            checkVeilederTilgang(
                ...
                call.respond(
                    ...
                    AktivitetskravResponseDTO.Companion.from(createdAktivitetskrav)
                )
            }
        }
                ...
                val responseDTO =
                    GetAktivitetskravForPersonsResponseDTO(
                        aktivitetskravvurderinger = aktivitetskravvurderinger.map {
                            it.key.value to AktivitetskravResponseDTO.Companion.from(it.value)
                        }.toMap()
                    )
